...
#from VMeshTools.VMAPMeshReader import VMAPMeshReader
#from VMeshTools.VMAPMeshWriter import VMAPMeshWriter
#from VMeshTools.VMeshTools import VMAPFileHandler
...
def main():
    if __name__ == '__main__':
        ...
        vmt.VMAPMeshGroup(vh, "/VMAP/GEOMETRY/5").writeMesh_vedo(boat, "A tiny Boat")
        #geom1[2].getElements(True)
        mesh3 = geom1[2].renderMesh_vedo()
        mesh3 = vmt.VMAPMeshGroup(vh, "/VMAP/GEOMETRY/5").renderMesh_vedo()
